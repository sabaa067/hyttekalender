...
export function AssistantButton({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        className="top-[calc(env(safe-area-inset-top,0px)+1rem)] max-h-[calc(100dvh-env(safe-area-inset-top,0px)-2rem)] translate-y-0 gap-0 overflow-y-auto rounded-3xl border-border/60 bg-card/95 p-3 shadow-2xl backdrop-blur-xl sm:top-[8%] sm:max-h-[85vh] sm:translate-y-[-8%] sm:max-w-2xl sm:p-4"
      >
